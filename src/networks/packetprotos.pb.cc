...
void protobuf_AssignDesc_packetprotos_2eproto() {
  ...
  static const int RenderedObj_offsets_[19] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RenderedObj, size_),
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RenderedObj, roll_vector_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RenderedObj, pitch_vector_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RenderedObj, yaw_vector_),
...
const int RenderedObj::kSizeFieldNumber;
...
const int RenderedObj::kRollVectorFieldNumber;
const int RenderedObj::kPitchVectorFieldNumber;
const int RenderedObj::kYawVectorFieldNumber;
...
void RenderedObj::InitAsDefaultInstance() {
  ...
  roll_vector_ = const_cast< ::protos::vector*>(&::protos::vector::default_instance());
  pitch_vector_ = const_cast< ::protos::vector*>(&::protos::vector::default_instance());
  yaw_vector_ = const_cast< ::protos::vector*>(&::protos::vector::default_instance());
}
...
void RenderedObj::Clear() {
  ...
  if (_has_bits_[8 / 32] & (0xffu << (8 % 32))) {
    ...
    accel_ = 0;
    if (has_roll_vector()) {
      if (roll_vector_ != NULL) roll_vector_->::protos::vector::Clear();
    }
    if (has_pitch_vector()) {
      if (pitch_vector_ != NULL) pitch_vector_->::protos::vector::Clear();
    }
    if (has_yaw_vector()) {
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 4: {
        ...
        if (input->ExpectTag(45)) goto parse_cur_tolerance;
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(53)) goto parse_max_tolerance;
        break;
      }
      ...
      case 6: {
        ...
        if (input->ExpectTag(56)) goto parse_is_destroyed;
        break;
      }
      ...
      case 8: {
        ...
        if (input->ExpectTag(74)) goto parse_vel;
        break;
      }
      ...
      case 9: {
        ...
        if (input->ExpectTag(85)) goto parse_accel;
        break;
      }
      ...
      case 10: {
        ...
        if (input->ExpectTag(90)) goto parse_roll_vector;
        break;
      }

      // required .protos.vector roll_vector = 11;
      case 11: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_LENGTH_DELIMITED) {
         parse_roll_vector:
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
               input, mutable_roll_vector()));
        } else {
          goto handle_uninterpreted;
        }
        if (input->ExpectTag(98)) goto parse_pitch_vector;
        break;
      }

      // required .protos.vector pitch_vector = 12;
      case 12: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_LENGTH_DELIMITED) {
         parse_pitch_vector:
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
               input, mutable_pitch_vector()));
        } else {
          goto handle_uninterpreted;
        }
        if (input->ExpectTag(106)) goto parse_yaw_vector;
        break;
      }
      ...
      case 13: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_yaw_vector:
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
               input, mutable_yaw_vector()));
        } else {
          goto handle_uninterpreted;
        }
        if (input->ExpectTag(117)) goto parse_pitch;
        break;
      }
      ...
      case 14: {
        ...
        if (input->ExpectTag(125)) goto parse_roll;
        break;
      }
      ...
      case 15: {
        ...
        if (input->ExpectTag(133)) goto parse_yaw;
        break;
      }
...
void RenderedObj::SerializeWithCachedSizes(
  ...
  if (has_cur_tolerance()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(5, this->cur_tolerance(), output);
  }

  // required float max_tolerance = 6;
  if (has_max_tolerance()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(6, this->max_tolerance(), output);
  }

  // required uint32 is_destroyed = 7;
  if (has_is_destroyed()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(7, this->is_destroyed(), output);
  }
  ...
  if (has_roll_vector()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      11, this->roll_vector(), output);
  }

  // required .protos.vector pitch_vector = 12;
  if (has_pitch_vector()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      12, this->pitch_vector(), output);
  }

  // required .protos.vector yaw_vector = 13;
  if (has_yaw_vector()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      13, this->yaw_vector(), output);
  }
...
::google::protobuf::uint8* RenderedObj::SerializeWithCachedSizesToArray(
  ...
  // required float cur_tolerance = 5;
  if (has_cur_tolerance()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(5, this->cur_tolerance(), target);
  }

  // required float max_tolerance = 6;
  if (has_max_tolerance()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(6, this->max_tolerance(), target);
  }

  // required uint32 is_destroyed = 7;
  if (has_is_destroyed()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(7, this->is_destroyed(), target);
  }
...
void RenderedObj::MergeFrom(const RenderedObj& from) {
  ...
  if (from._has_bits_[8 / 32] & (0xffu << (8 % 32))) {
    ...
    if (from.has_roll_vector()) {
      mutable_roll_vector()->::protos::vector::MergeFrom(from.roll_vector());
    }
    if (from.has_pitch_vector()) {
      mutable_pitch_vector()->::protos::vector::MergeFrom(from.pitch_vector());
    }
    if (from.has_yaw_vector()) {
      mutable_yaw_vector()->::protos::vector::MergeFrom(from.yaw_vector());
    }
    if (from.has_pitch()) {
...
bool RenderedObj::IsInitialized() const {
  ...
  if (has_roll_vector()) {
    if (!this->roll_vector().IsInitialized()) return false;
  }
  if (has_pitch_vector()) {
    if (!this->pitch_vector().IsInitialized()) return false;
  }
  if (has_yaw_vector()) {
    if (!this->yaw_vector().IsInitialized()) return false;
  }
  return true;
}
...
void RenderedObj::Swap(RenderedObj* other) {
  if (other != this) {
    ...
    std::swap(roll_vector_, other->roll_vector_);
    std::swap(pitch_vector_, other->pitch_vector_);
    std::swap(yaw_vector_, other->yaw_vector_);
