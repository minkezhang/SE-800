...
class RenderedObj : public ::google::protobuf::Message {
 public:
  ...
  static const int kCurToleranceFieldNumber = 3;
  ...
  static const int kMaxToleranceFieldNumber = 4;
  ...
  static const int kIsDestroyedFieldNumber = 5;
  ...
  static const int kYawFieldNumber = 11;
  ...
  static const int kWeaponIndexFieldNumber = 12;
